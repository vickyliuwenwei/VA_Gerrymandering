...
function makeHist_egs(old_csvdata, col, var_svg_id, xlabel) {
    ...
    svg_egs.selectAll("rect")
      ...
      .append("rect")
      .attr("x", 1)
      .attr("transform", function(d) { return "translate(" + xScale_old(d.x0) + "," + yScale_egs(d.length) + ")"; })
...
function updateHist_hmss(csvdata, col, var_svg_id) {
    ...
    .value(function(d) { return +d[col]; })
    .domain(xScale_hmss.domain())
    .thresholds(xScale_hmss.ticks(numBuckets));
...
function makeHist_votes(old_csvdata, col, var_svg_id, xlabel) {
    ...
    svg_p_votes.selectAll("rect")
      ...
      .append("rect")
      .attr("x", 1)
      .attr("transform", function(d) { return "translate(" + xScale_old(d.x0) + "," + yScale_p_votes(d.length) + ")"; })
      .attr("width", xScale_old(bins[0].x1) - xScale_old(bins[0].x0) - 1)
...
function makeHist_cuts2(old_csvdata, col, var_svg_id, xlabel) {
    ...
    .thresholds(xScale_nb_cuts2.ticks(numBuckets)); // split into 20 bins
    ...
    svg_nb_cuts2.selectAll("rect")
      ...
      .attr("width", xScale_old(bins[0].x1) - xScale_old(bins[0].x0) - 1)
      .attr("height", function(d) { return height - yScale_nb_cuts2(d.length); })
      .style("fill", "#69b3a2")
      .style("opacity", 0.4);
    ...
    .attr("class", "y axis")
    .attr("transform", "translate(0,0)")
    .call(d3.axisLeft(yScale_nb_cuts2));
...
function makeHist_votes2(old_csvdata, col, var_svg_id, xlabel) {
    ...
    .thresholds(xScale_p_votes2.ticks(numBuckets)); // split into 20 bins
    ...
    svg_p_votes2.selectAll("rect")
      ...
      .append("rect")
      .attr("x", 1)
      .attr("transform", function(d) { return "translate(" + xScale_old(d.x0) + "," + yScale_p_votes2(d.length) + ")"; })
      .attr("width", xScale_old(bins[0].x1) - xScale_old(bins[0].x0) - 1)
      .attr("height", function(d) { return height - yScale_p_votes2(d.length); })
      .style("fill", "#69b3a2")
      .style("opacity", 0.4);
    ...
    .attr("class", "y axis")
    .attr("transform", "translate(0,0)")
    .call(d3.axisLeft(yScale_p_votes2));
...
function makeHist_egs2(old_csvdata, col, var_svg_id, xlabel) {
    ...
    .thresholds(xScale_egs2.ticks(numBuckets)); // split into 20 bins
    ...
    svg_egs2.selectAll("rect")
      ...
      .append("rect")
      .attr("x", 1)
      .attr("transform", function(d) { return "translate(" + xScale_old(d.x0) + "," + yScale_egs2(d.length) + ")"; })
      .attr("width", xScale_old(bins[0].x1) - xScale_old(bins[0].x0) - 1)
      .attr("height", function(d) { return height - yScale_egs2(d.length); })
      .style("fill", "#69b3a2")
      .style("opacity", 0.4);
...
function makeHist_mms2(old_csvdata, col, var_svg_id, xlabel) {
    ...
    svg_mms2.selectAll("rect")
      ...
      .attr("width", xScale_old(bins[0].x1) - xScale_old(bins[0].x0) - 1)
      .attr("height", function(d) { return height - yScale_mms2(d.length); })
      .style("fill", "#69b3a2")
      .style("opacity", 0.4);
...
function makeHist_hmss2(old_csvdata, col, var_svg_id, xlabel) {
    ...
    .thresholds(xScale_hmss2.ticks(numBuckets)); // split into 20 bins
    ...
    svg_hmss2.selectAll("rect")
      ...
      .attr("width", xScale_old(bins[0].x1) - xScale_old(bins[0].x0) - 1)
      .attr("height", function(d) { return height - yScale_hmss2(d.length); })
      .style("fill", "#69b3a2")
      .style("opacity", 0.4);
